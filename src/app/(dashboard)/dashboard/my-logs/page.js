  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold">My Request Logs</h2>
                  ...
                  return (
                    <tr key={i} className="hover:bg-primary/5 transition-colors">
                      ...
                      <td className="px-3 py-1.5 border-r border-border">
                        <span className="px-1.5 py-0.5 rounded bg-bg-subtle border border-border text-[10px] uppercase font-bold">{parts[2]}</span>
                      </td>
                      ...
                      <td className={`px-3 py-1.5 font-bold ${isSuccess ? "text-success" : isFailed ? "text-error" : "text-primary"}`}>{status}</td>
                    </tr>
                  );
                })}
              </tbody>
