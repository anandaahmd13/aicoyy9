...
export const TABLES = {
  ...
  apiKeys: {
    columns: {
      ...
      expiresAt: "TEXT",
      // JSON { providers: { [providerId]: string[] } }; null = unrestricted.
      // Empty model array for a provider = all of that provider's models.
      scopes: "TEXT",
    },
    indexes: [
  ...
  users: {
    ...
    indexes: ["CREATE INDEX IF NOT EXISTS idx_users_username ON users(username)"],
  },
  combos: {
    columns: {
      id: "TEXT PRIMARY KEY",
